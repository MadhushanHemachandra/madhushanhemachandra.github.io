...
<body>
  ...
  <!-- I only added the below code until reaches the closing body tag, after submitting this project to mia. -->

  <script src="https://polyfill.io/v3/polyfill.min.js?features=default"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDnTuHiXoriipFhPVrpBsviWjqi1VCMrp4&callback=initMap&v=weekly" defer></script>

  <script>
    // Initialize and add the map
    function initMap() {
      // The location of sri_lanka
      const sri_lanka = { lat: 6.931970, lng: 79.857750 };
      // The map, centered at sri_lanka
      const map = new google.maps.Map(document.querySelector(".map"), {
        zoom: 4,
        center: sri_lanka,
      });
      // The marker, positioned at sri_lanka
